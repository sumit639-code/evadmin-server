      ...
      <nav className={`fixed w-full z-50 transition-all duration-300 ${
        ...
        <div className="container mx-auto px-4 flex justify-between items-center">
          <Link to="/" className="flex items-center">
            <span className="text-2xl font-bold text-green-600">ScooterRent</span>
          </Link>
          <div className="hidden md:flex space-x-8">
            ...
            <a href="#faqs" className="text-gray-700 hover:text-green-600 transition">FAQs</a>
          </div>
          <div className="flex space-x-4">
            <Link to="/login" className="px-4 py-2 text-green-600 border border-green-600 rounded-md hover:bg-green-50 transition">
              Login
            </Link>
      ...
      <section className="pt-28 pb-16 md:pt-40 md:pb-24 bg-gradient-to-br from-green-50 to-white">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-12 md:mb-0">
            ...
            >
              Explore the city with convenience and style. Affordable, reliable, and eco-friendly scooters available 24/7.
            </motion.p>
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <Link to="/available-vehicles" className="px-8 py-3 bg-green-600 text-white rounded-md text-center hover:bg-green-700 transition shadow-md">
                Browse Vehicles
              </Link>
              <Link to="/register" className="px-8 py-3 border border-green-600 text-green-600 rounded-md text-center hover:bg-green-50 transition">
                Sign Up Now
              </Link>
            </motion.div>
          </div>
            ...
            >
              <img 
                ...
                onError={(e) => {
                  ...
                  e.target.src = "https://via.placeholder.com/600x400?text=Scooter+Rental";
                }}
              />
      ...
      <section id="features" className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Why Choose ScooterRent</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We provide the best scooter rental experience with premium vehicles and exceptional service.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Our scooters are regularly serviced and maintained to ensure safety and reliability."
              },
              {
                icon: <MdLocationOn className="text-4xl text-green-600 mb-4" />,
                title: "Convenient Locations",
                description: "Pick up and drop off at multiple locations throughout the city."
              },
              {
              ...
              },
              {
                ...
                title: "Eco-Friendly",
                description: "Reduce your carbon footprint by choosing our electric scooters."
              }
            ].map((feature, index) => (
              <motion.div
                key={index}
      ...
      <section id="how-it-works" className="py-16 md:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Renting a scooter has never been easier. Follow these simple steps to get started.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Sign up and verify your identity with a valid driver's license."
              },
              {
                step: "2",
                title: "Find a Scooter",
                description: "Browse available scooters near you and select the one you like."
              },
              {
                step: "3",
                title: "Book & Pay",
                description: "Reserve your scooter and make a secure payment online."
              },
              {
                step: "4",
                title: "Ride & Return",
                description: "Enjoy your ride and return the scooter to any designated location."
              }
            ].map((item, index) => (
              <motion.div
                key={index}
              ...
              >
                ...
                {index < 3 && <div className="hidden md:block absolute top-1/2 -right-8 transform -translate-y-1/2 text-green-600 text-4xl">→</div>}
      ...
      <section id="testimonials" className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Don't just take our word for it. See what our satisfied customers have to say about ScooterRent.
            </p>
          </div>
            ...
            {[
              {
                ...
                answer: "Yes, a valid driver's license is required for all rentals. You must be at least 18 years old to rent a scooter."
              },
              {
                question: "What happens if the scooter breaks down?",
                answer: "If you experience any issues with your rented scooter, contact our 24/7 support line immediately. We'll assist you promptly and arrange for a replacement if necessary."
              },
            //   {
            ...
            //   },
              {
                ...
                answer: "Yes, cancellations made 24 hours before the rental start time are eligible for a full refund."
              },
              {
                question: "Are helmets provided?",
                answer: "Yes, helmets are provided with all rentals and must be worn at all times while operating the vehicle."
              }
            ].map((faq, index) => (
              <motion.div 
                key={index}
      ...
      <section className="py-16 md:py-24 bg-green-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join thousands of satisfied customers and experience the freedom of exploring on two wheels.
          </p>
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <Link to="/available-vehicles" className="px-8 py-3 bg-white text-green-600 rounded-md text-center hover:bg-gray-100 transition shadow-md font-semibold">
              Browse Available Scooters
            </Link>
            <Link to="/register" className="px-8 py-3 border-2 border-white text-white rounded-md text-center hover:bg-green-700 transition font-semibold">
              Create an Account
            </Link>
          </div>
        </div>
      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-2xl font-bold text-green-400 mb-4">ScooterRent</h3>
              <p className="text-gray-300 mb-4">
                Providing convenient and eco-friendly transportation solutions since 2020.
              </p>
              <div className="flex space-x-4">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#faqs" className="text-gray-300 hover:text-white transition">FAQs</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-300 hover:text-white transition">Rental Agreement</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition">Privacy Policy</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition">Terms of Service</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition">Safety Guidelines</a></li>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} ScooterRent. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
